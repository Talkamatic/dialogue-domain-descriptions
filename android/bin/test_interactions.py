...
if gui_selected_test == "":
    print "Running tests from android/test/interaction_tests_eng.txt"
    result = subprocess.call(
        "tdm_test_interactions.py -p android_mocked_project -L eng"
        " -f android/test/interaction_tests_eng.txt" + 
        selected_test,
        shell=True)

if selected_test == "":
    print "Running tests from android/test/interaction_tests_gui_eng.txt"
    result_gui = subprocess.call(
        "tdm_test_interactions.py -p android_mocked_project -L eng"
        " -f android/test/interaction_tests_gui_eng.txt" +
        gui_selected_test,
        shell=True)
